...
namespace Gerdemann\BotMan\Drivers\RocketChat;
...
class RocketChatDriver extends HttpDriver
{
    ...
    {
        return !empty($this->config->get('outgoingToken')) && !empty($this->config->get('incomingEndpoint')) && !empty($this->config->get('matchingKeys'));
    }
    ...
    {
        $url = $this->config->get('incomingEndpoint');
